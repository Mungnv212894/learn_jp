...
public class UserController {
    ...
    public String getHomePage(Model model) {
        List<User> arrUsers = this.userService.getAllUsersByEmail("mung@gmail.com");
        System.out.println(arrUsers);

        model.addAttribute("thu", "test");
        model.addAttribute("mung", "from controller with model");
        return "hello";
    }
    ...
    public String createUserPage(Model model,
            @ModelAttribute("newUser") User mung,
